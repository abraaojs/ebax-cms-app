...
import { colors_fill } from "../../../utils/colors.object";

const BottonDetail = (props: any) => {
  const { color } = props;
  return (
    <div className="notch relative bottom-[1px] w-full flex justify-between b-none">
      <div className="w-radius-primary aspect-square"></div>
      <svg
        viewBox="0 0 167 30"
        className={`${colors_fill[color]} h-full max-h-[30px] aspect-[167/30]`}
